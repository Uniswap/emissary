...
contract KeyManagerEmissaryTest is Test, P256VerifierEtcher {
    ...
    function test_registerKey_Secp256k1Key() public {
        ...
        emit GenericKeyManager.KeyRegistered(sponsor1, keyHash, KeyType.Secp256k1, ResetPeriod.OneDay);
    ...
    function test_registerKey_P256Key() public {
        ...
        vm.prank(sponsor1);
        vm.expectEmit(true, true, false, true);
        emit GenericKeyManager.KeyRegistered(sponsor1, keyHash, KeyType.P256, ResetPeriod.TenMinutes);
        emissary.registerKey(key.keyType, key.publicKey, key.resetPeriod);
    ...
    function test_registerKey_WebAuthnP256Key() public {
        ...
        vm.prank(sponsor1);
        vm.expectEmit(true, true, false, true);
        emit GenericKeyManager.KeyRegistered(sponsor1, keyHash, KeyType.WebAuthnP256, ResetPeriod.OneHourAndFiveMinutes);
        emissary.registerKey(key.keyType, key.publicKey, key.resetPeriod);
    ...
    function test_revert_registerKey_DuplicateKey() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(GenericKeyManager.KeyAlreadyRegistered.selector, sponsor1, key.hash()));
        emissary.registerKey(key.keyType, key.publicKey, key.resetPeriod);
        vm.stopPrank();
    }
    ...
    function test_revert_registerKey_InvalidKey() public {
        ...
        vm.prank(sponsor1);
        vm.expectRevert(abi.encodeWithSelector(GenericKeyManager.InvalidKey.selector, invalidKey.hash()));
    ...
    function test_scheduleKeyRemoval() public {
        ...
        vm.prank(sponsor1);
        vm.expectEmit(true, true, false, true);
        emit GenericKeyManager.KeyRemovalScheduled(sponsor1, keyHash, expectedRemovalTime);
    ...
    function test_removeKey_AfterTimelock() public {
        ...
        emit GenericKeyManager.KeyRemoved(sponsor1, keyHash);
